defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    sections =
      [
        ...
        worker_yaml(worker_ssh_hosts, worker_max_concurrent_agents_per_host, worker_mode),
        "agent:",
  ...
  defp worker_yaml(ssh_hosts, max_concurrent_agents_per_host, mode)
       when ssh_hosts in [nil, []] and is_nil(max_concurrent_agents_per_host) and is_nil(mode),
       do: nil

  defp worker_yaml(ssh_hosts, max_concurrent_agents_per_host, mode) do
    [
      "worker:",
      ssh_hosts not in [nil, []] && "  ssh_hosts: #{yaml_value(ssh_hosts)}",
      !is_nil(max_concurrent_agents_per_host) &&
        "  max_concurrent_agents_per_host: #{yaml_value(max_concurrent_agents_per_host)}",
      !is_nil(mode) && "  mode: #{yaml_value(mode)}"
    ]
